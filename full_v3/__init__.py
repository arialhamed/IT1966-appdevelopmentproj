...
try:
    ...
    from flask import Flask, render_template, request, redirect, url_for, session
from Forms import CreateCustomerForm, LoginCustomerForm, LoginAdminForm, UpdateCustomerForm, CreateFaqForm, ResetPasswordForm, ForgetPasswordForm, CreateReviewForm, CreateTransactionForm, Createproduct, Uploadimage
from decimal import Decimal
from datetime import datetime

import shelve, Customer, Email, FAQ, Review, os, Products, Transaction
        ...
        if customer_dict:
            for key in customer_dict:
                ...
                if username == create_customer_form.username.data and create_customer_form.email.data:
                    ...
                    print("For Programmer: SUCCESS --> {} has been successfully stored in CustomerStorage.db. customer_id == {} and username == {}".format(customer.get_firstName(), customer.get_customer_id(), customer.get_username()))
